  ...
  return (
    <div>
      <section className="mb-0">
        ...
        <p className="text-lg text-gray-700 font-semibold"><strong>ByteCTF 2024|CrossVue</strong> 客户端CSTI 偷取flag cookie</p>
        <p className="text-lg text-gray-700 font-semibold"><strong>D^3CTF 2024|d3pythonhttp</strong> HTTP请求走私 Pickle反序列化 web.py 内存马注入</p>
      </section>
    </div>
  );
}
